...
[![Framework](https://img.shields.io/badge/SpinForge-Extension-8E44AD.svg)](https://github.com/Andrey-veksler/SpinForge)
...
├── gam3arch_v2_clean.py    # V2 simplified simulation (with FOMO)
├── bridge_extractor.py     # Infer bridge matrix from telemetry
├── dashboard.py            # Streamlit interactive dashboard
├── requirements.txt        # numpy, pandas
├── sample_data.csv         # Example player data
├── sample_telemetry.csv    # Example zone transition data
├── pyproject.toml          # Package configuration
└── tests/
    └── test_gam3arch.py    # Unit tests (21 tests)
```
...
GAM3ARCH provides the cognitive architecture. **[SpinForge](https://github.com/Andrey-veksler/SpinForge)** applies it to esports event design — translating the four-zone model into tournament scheduling with the Event Pulse monitoring system. If GAM3ARCH is the theory, SpinForge is the practice.
